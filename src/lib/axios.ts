...
export class AxiosManager {
  ...
  private async authRequestInterceptor(axiosConfig: AxiosRequestConfig) {
  ...
  private async refreshTokenRequestInterceptor(axiosConfig: AxiosRequestConfig) {
